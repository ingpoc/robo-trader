      ...
      <Card className="shadow-xl border-0 bg-white/90 dark:bg-warmgray-800/90 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-warmgray-600 dark:text-warmgray-400">No earnings reports found for the selected stock</p>
          </div>
        </CardContent>
      </Card>
    )
      ...
      <CardContent>
        <div className="space-y-6">
          {earnings.map((report) => (
            <article
              key={report.id}
              className="border border-warmgray-200 dark:border-warmgray-700 rounded-xl p-6 bg-gradient-to-r from-white to-warmgray-50 dark:from-warmgray-800 dark:to-warmgray-800/50 hover:shadow-lg transition-all duration-300"
            >
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                {/* Period Info */}
                <div className="lg:col-span-1">
                  <h4 className="font-bold text-xl text-warmgray-900 dark:text-warmgray-100 mb-2">
                    {report.fiscal_period}
                  </h4>
                  <div className="flex items-center gap-2 text-warmgray-600 dark:text-warmgray-400 mb-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white dark:bg-warmgray-700 rounded-lg p-4 border border-warmgray-200 dark:border-warmgray-600">
