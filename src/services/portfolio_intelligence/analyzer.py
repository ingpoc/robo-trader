...
from src.services.portfolio_intelligence.prompt_builder import PortfolioPromptBuilder
from src.services.portfolio_intelligence.analysis_executor import PortfolioAnalysisExecutor
from src.services.portfolio_intelligence.analysis_logger_helper import PortfolioAnalysisLoggerHelper
from src.services.portfolio_intelligence.storage_handler import PortfolioStorageHandler
...
class PortfolioIntelligenceAnalyzer:
    ...
    async def analyze_portfolio_intelligence(
        ...
        try:
            ...
            await self.logger_helper.log_error_to_transparency(analysis_id, agent_name, str(e))
