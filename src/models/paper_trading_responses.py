...
class OpenPositionResponse(BaseModel):
    ...
    current_price: Optional[float] = Field(None, description="Current market price (INR)")
    current_value: Optional[float] = Field(None, description="Current position value (INR)")
    unrealized_pnl: Optional[float] = Field(None, description="Unrealized P&L (INR)")
    ...
    market_price_status: str = Field(
        default="live",
        description="Whether the current mark is live or unavailable for truthful valuation",
    )
