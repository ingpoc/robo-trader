...
class ClaudeAgentCoordinator(BaseCoordinator):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            self.tool_coordinator = AgentToolCoordinator(self.config, self.tool_executor)
            ...
            system_prompt_text = self.prompt_builder.build_system_prompt("swing_trading")
    ...
    async def run_morning_prep_session(
        ...
        return await self.session_coordinator.run_morning_prep_session(account_type, context)
    ...
    async def run_evening_review_session(
        ...
        return await self.session_coordinator.run_evening_review_session(account_type, context)
