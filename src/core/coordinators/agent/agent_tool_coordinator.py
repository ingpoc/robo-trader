    ...
    def _create_tools(self) -> None:
        ...
        async def execute_trade_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Trade execution failed: {str(e)}"}], "is_error": True}
        ...
        async def close_position_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Position close failed: {str(e)}"}], "is_error": True}
        ...
        async def check_balance_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Balance check failed: {str(e)}"}], "is_error": True}
        ...
        async def get_market_data_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Market data fetch failed: {str(e)}"}], "is_error": True}
        ...
        async def analyze_portfolio_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Portfolio analysis failed: {str(e)}"}], "is_error": True}
        ...
        async def get_open_positions_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Open positions fetch failed: {str(e)}"}], "is_error": True}
        ...
        async def calculate_risk_metrics_tool(args: Dict[str, Any]) -> Dict[str, Any]:
            try:
                ...
                return {"content": [{"type": "text", "text": f"Risk metrics calculation failed: {str(e)}"}], "is_error": True}
