    ...
    async def record_execution(
        ...
        async with self._lock:
            try:
                ...
                logger.info(f"📊 EXECUTION TRACKER: Recorded {execution_type} execution: {task_name} ({task_id or 'no-id'}) by {user} - {symbol_info}, status: {status}, time: {execution_time:.2f}s" if execution_time else f"📊 EXECUTION TRACKER: Recorded {execution_type} execution: {task_name} ({task_id or 'no-id'}) by {user} - {symbol_info}, status: {status}")
                logger.info(f"📊 EXECUTION TRACKER: Database insert completed for {task_name}")
